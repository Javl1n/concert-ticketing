            ...
            <nav x-data="{ open: false }" class="">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <a href="/" wire:navigate>
                                    {{-- <x-application-logo class="block h-9 w-auto fill-current text-violet-600" /> --}}
                                    <h1 class="text-3xl font-bold text-violet-600">{{ __('Concert Ticketing System') }}</h1>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center text-violet-600 gap-4">
                            <a
                                href="{{ route('login') }}"
                                class="font-bold"
                            >
                            ...
                            @if (Route::has('register'))
                                <a
                                    href="{{ route('register') }}"
                                    class="font-bold px-4 py-1 rounded-full border-2 border-violet-600"
                                >
                                    Sign up
                                </a>
                            @endif
